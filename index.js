...
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#e8e8f0;min-height:100vh;padding:1rem;position:relative;}
.bg-img{position:fixed;inset:0;z-index:0;background:url('${BG}') center/cover no-repeat;}
.bg-overlay{position:fixed;inset:0;z-index:1;background:linear-gradient(180deg,rgba(5,8,20,0.82) 0%,rgba(10,15,35,0.72) 40%,rgba(10,15,35,0.72) 70%,rgba(5,8,20,0.92) 100%);}
.wrap{position:relative;z-index:2;}
.header{text-align:center;padding:1.2rem 0 0.4rem}
.header h1{font-size:1.3rem;font-weight:700;color:#fff;text-shadow:0 2px 8px rgba(0,0,0,0.5)}
.mois-nav{display:flex;align-items:center;justify-content:center;gap:8px;margin:0.5rem 0 0.2rem}
.mois-nav button{background:rgba(255,255,255,0.1);border:1px solid rgba(255,255,255,0.2);color:#aaa;border-radius:8px;padding:5px 12px;font-size:0.75rem;cursor:pointer;backdrop-filter:blur(8px)}
.mois-nav button:hover{background:rgba(255,255,255,0.18);color:#fff}
.mois-label{font-size:0.85rem;color:#fff;font-weight:600;min-width:140px;text-align:center}
.mois-badge{font-size:0.62rem;color:rgba(255,255,255,0.4);text-align:center;padding-bottom:0.3rem}
.tabs{display:flex;gap:4px;max-width:420px;margin:0.6rem auto;background:rgba(255,255,255,0.08);border-radius:12px;padding:4px;backdrop-filter:blur(10px)}
.tab{flex:1;text-align:center;padding:6px 2px;font-size:0.63rem;border-radius:8px;cursor:pointer;color:rgba(255,255,255,0.4);transition:all 0.2s}
...
.card{background:rgba(10,15,35,0.6);border-radius:14px;padding:0.9rem;border:1px solid rgba(255,255,255,0.12);backdrop-filter:blur(12px)}
.card.full{grid-column:1/-1}
.label{font-size:0.62rem;text-transform:uppercase;letter-spacing:0.07em;color:rgba(255,255,255,0.4);margin-bottom:5px}
.value{font-size:1.5rem;font-weight:700}
.sub{font-size:0.65rem;color:rgba(255,255,255,0.35);margin-top:3px}
.green{color:#4ade80}.amber{color:#fbbf24}.red{color:#f87171}.blue{color:#60a5fa}
.bar{height:5px;background:rgba(255,255,255,0.1);border-radius:3px;overflow:hidden;margin:7px 0 3px}
.fill{height:100%;border-radius:3px;transition:width 0.5s}
.row{display:flex;justify-content:space-between;align-items:center;padding:6px 0;border-bottom:1px solid rgba(255,255,255,0.08);font-size:0.78rem}
.row:last-child{border-bottom:none}
.mini-bar{width:50px;height:4px;background:rgba(255,255,255,0.1);border-radius:2px;overflow:hidden}
.mini-fill{height:100%;border-radius:2px}
.obj{padding:9px 0;border-bottom:1px solid rgba(255,255,255,0.08)}
...
.cours-row{display:flex;justify-content:space-between;font-size:0.72rem;padding:4px 0;border-bottom:1px solid rgba(255,255,255,0.08)}
.cours-row:last-child{border-bottom:none}
.cat-btn{display:flex;justify-content:space-between;align-items:center;padding:7px 0;border-bottom:1px solid rgba(255,255,255,0.08);cursor:pointer;font-size:0.78rem;transition:all 0.15s}
.cat-btn:last-child{border-bottom:none}
.cat-btn:hover{opacity:0.8}
.cat-btn .chevron{color:rgba(255,255,255,0.35);font-size:0.7rem;transition:transform 0.2s}
.cat-btn.open .chevron{transform:rotate(90deg)}
.cat-detail{display:none;background:rgba(0,0,0,0.3);border-radius:8px;padding:6px 10px;margin:2px 0 6px}
.cat-detail.open{display:block}
.dep-item{display:flex;justify-content:space-between;font-size:0.7rem;padding:3px 0;border-bottom:1px solid rgba(255,255,255,0.06);color:rgba(255,255,255,0.55)}
.dep-item:last-child{border-bottom:none}
.dep-date{color:rgba(255,255,255,0.3);font-size:0.65rem}
.dep-total-bar{display:flex;justify-content:space-between;align-items:center;margin-top:10px;padding:8px 10px;background:rgba(255,255,255,0.07);border-radius:8px;border:1px solid rgba(255,255,255,0.12);font-size:0.78rem}
.prel-row{display:flex;justify-content:space-between;align-items:center;padding:7px 0;border-bottom:1px solid rgba(255,255,255,0.08);font-size:0.75rem}
...
.prel-section-title{font-size:0.65rem;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:0.06em;margin:10px 0 4px}
.alert-box{background:rgba(61,45,10,0.7);border:1px solid rgba(251,191,36,0.3);border-radius:10px;padding:10px 12px;margin-bottom:10px;font-size:0.75rem;backdrop-filter:blur(8px)}
.alert-box .alert-title{color:#fbbf24;font-weight:600;margin-bottom:4px;font-size:0.8rem}
.rev-row{display:flex;justify-content:space-between;align-items:center;padding:7px 0;border-bottom:1px solid rgba(255,255,255,0.08);font-size:0.78rem}
.rev-row:last-child{border-bottom:none}
.refresh{position:fixed;bottom:1.2rem;right:1.2rem;background:#6366f1;color:#fff;border:none;border-radius:50%;width:44px;height:44px;font-size:1.1rem;cursor:pointer;box-shadow:0 3px 10px rgba(99,102,241,0.5);z-index:10}
.updated{text-align:center;font-size:0.62rem;color:rgba(255,255,255,0.2);padding:1rem 0 4rem}
.badge-hist{display:inline-block;font-size:0.6rem;background:rgba(99,102,241,0.2);color:#a5b4fc;border:1px solid rgba(99,102,241,0.3);border-radius:6px;padding:2px 7px;margin-left:6px}
</style>
</head>
<body>
...
<div class="section active" id="tab-apercu">
  <div class="grid">
    ...
    <div class="card"><div class="label">Charges fixes</div><div class="value amber" id="a-cf">—</div><div class="sub" id="a-cf-s">—</div></div>
    <div class="card"><div class="label">Solde estimé</div><div class="value" id="a-sl">—</div><div class="bar"><div class="fill" id="a-sl-b" style="width:0%"></div></div></div>
...
<div class="section" id="tab-revenus">
  <div class="grid">
    <div class="card full" id="r-ls">Chargement...</div>
  </div>
</div>
...
function setTab(t){
  const tabs = ['apercu','completude','revenus','budgets','prelevements','objectifs'];
...
function renderRevenus(d) {
  const rl = document.getElementById('r-ls');
  const isCurrent = d.mois_offset === 0;
  rl.innerHTML = '<div class="label" style="margin-bottom:10px">Revenus du mois' + (isCurrent ? '' : ' <span class="badge-hist">Archivé</span>') + '</div>';

  const sources = [
    { nom: 'Salaire LGM', val: d.salaire, ico: '💼' },
    { nom: 'Beau-frère', val: d.beau_frere, ico: '👤' },
    { nom: 'Complétude cours', val: d.completude, ico: '📚' },
  ];
  sources.forEach(s => {
    rl.innerHTML += '<div class="rev-row"><span>' + s.ico + ' ' + s.nom + '</span><span class="green">+' + fmt(s.val) + '</span></div>';
  });

  if (d.revenus_supp && d.revenus_supp.length > 0) {
    rl.innerHTML += '<div class="label" style="margin:10px 0 5px">Rentrées supplémentaires</div>';
    d.revenus_supp.forEach(r => {
      rl.innerHTML += '<div class="rev-row"><span>' + (r.libelle || 'Divers') + '</span><span class="green">+' + r.montant.toFixed(2) + ' €</span></div>';
    });
  }

  rl.innerHTML += '<div class="dep-total-bar" style="margin-top:12px"><span style="font-weight:600">Total revenus</span><span class="green" style="font-weight:700;font-size:1rem">+' + fmt(d.total_revenus) + '</span></div>';
}
...
function renderBudgets(d) {
  ...
  Object.entries(d.totaux).forEach(([k,v]) => {
    ...
    bl.innerHTML += `<div class="cat-btn" id="cat-btn-${k}" onclick="${hasItems?'toggleDetail(\'' + k + '\')':''}" style="${!hasItems?'cursor:default':''}">
        <span>${b.label}</span>
      ...
      <div class="cat-detail" id="cat-det-${k}">
        ${items.length === 0 ? '<div style="color:rgba(255,255,255,0.3);font-size:0.7rem;padding:4px 0">Aucune dépense</div>' :
  ...
  const totalDep = Object.values(d.totaux).reduce((a,b)=>a+b,0);
  const totalMax = Object.values(d.budgets).reduce((a,b)=>a+b.max,0);
  const tPct = pct(totalDep, totalMax);
  const tCol = col(tPct);
  bl.innerHTML += '<div class="dep-total-bar"><div><span style="font-weight:600">Total dépenses</span><div style="font-size:0.6rem;color:rgba(255,255,255,0.35);margin-top:2px">Budget max : ' + totalMax + ' €</div></div><div style="text-align:right"><span style="color:' + tCol + ';font-weight:700;font-size:1rem">' + totalDep.toFixed(0) + ' €</span><div style="font-size:0.6rem;color:rgba(255,255,255,0.35)">' + tPct + '% du budget</div></div></div>';
}
...
function renderPrelevements(d) {
  ...
  if (isCurrent && d.prelevements_a_venir && d.prelevements_a_venir.length > 0) {
    ...
    pAlert.innerHTML = `<div class="alert-box"><div class="alert-title">⚠️ À venir dans 7 jours — ${totalSem.toFixed(0)}€</div>${d.prelevements_a_venir.map(p=>{const q=p.dansJours===0?'Aujourd\'hui':p.dansJours===1?'Demain':`Dans ${p.dansJours}j`;return `<div style="display:flex;justify-content:space-between;margin-top:3px"><span>${q} · ${p.nom}</span><span style="color:#fbbf24">${p.montant.toFixed(2)}€</span></div>`;}).join('')}</div>`;
  } else {
  ...
  if (!isCurrent) {
    ...
    pl.innerHTML += '<div style="font-size:0.75rem;color:rgba(255,255,255,0.35);padding:8px 0">Total mensuel: <span style="color:#e8e8f0">' + fmt(d.charges_fixes) + '</span></div>';
    d.prelevements_tous.filter(p=>p.frequence!=='trimestriel').forEach(p=>{pl.innerHTML+=`<div class="prel-row"><span>${p.nom}</span><div style="display:flex;gap:8px;align-items:center"><span style="color:rgba(255,255,255,0.3)">le ${p.jour||'—'}</span><span>${p.montant.toFixed(2)}€</span></div></div>`;});
    return;
  }
  pl.innerHTML = '<div class="label" style="margin-bottom:4px">Prélèvements du mois</div>';
  pl.innerHTML += `<div class="row" style="padding-bottom:8px"><span style="color:rgba(255,255,255,0.4)">Restant ce mois</span><span style="color:#f87171;font-weight:600">-${d.total_prelevements_restants.toFixed(0)}€</span></div>`;
  ...
  if (restants.length > 0) {
    ...
    restants.forEach(p => {
      ...
      if(diff===0){bc='prel-urgent';bt="Aujourd'hui";}
      else if(diff<=2){bc='prel-urgent';bt=`Dans ${diff}j`;}
      else if(diff<=5){bc='prel-soon';bt=`Dans ${diff}j`;}
      pl.innerHTML+=`<div class="prel-row"><span>${p.nom}</span><div style="display:flex;gap:8px;align-items:center"><span class="prel-badge ${bc}">${bt}</span><span>${p.montant.toFixed(2)}€</span></div></div>`;
    });
  }
  if (passes.length > 0) {
    pl.innerHTML += '<div class="prel-section-title">Déjà passés</div>';
    passes.forEach(p=>{pl.innerHTML+=`<div class="prel-row prel-past"><span>${p.nom}</span><div style="display:flex;gap:8px"><span style="color:rgba(255,255,255,0.3)">le ${p.jour}</span><span style="color:rgba(255,255,255,0.3)">${p.montant.toFixed(2)}€</span></div></div>`;});
  }
  if (trimest.length > 0) {
    pl.innerHTML += '<div class="prel-section-title">Trimestriels</div>';
    trimest.forEach(p=>{pl.innerHTML+=`<div class="prel-row"><span>${p.nom}</span><span style="color:rgba(255,255,255,0.4)">${p.montant.toFixed(2)}€/trim</span></div>`;});
  }
}
...
async function charger() {
  try {
    ...
    document.getElementById('a-cf').textContent = '-' + fmt(d.charges_fixes);
    document.getElementById('a-cf-s').textContent = 'Loyer, tontines, abonnements...';
    ...
    document.getElementById('c-ls').innerHTML = d.cours.length === 0
      ? '<div style="color:rgba(255,255,255,0.3);font-size:0.72rem;padding:6px 0">Aucun cours ce mois</div>'
      : d.cours.map(c => '<div class="cours-row"><span>' + c.eleve + (c.rattrapage ? ' <span style="color:rgba(255,255,255,0.35)">(rattrapage)</span>' : '') + '</span><span class="green">+' + c.gain.toFixed(2) + ' €</span></div>').join('');
